    ...
    <div className="photo-card">
      ...
      <div className="photo-card-actions">
        ...
        <div className="photo-action-buttons">
          <button type="button" onClick={handleDownload} className="btn-download" disabled={isDownloading}>
            {isDownloading ? (
              <>
          ...
          <div className="social-share-section">
            ...
            <div className="social-share-buttons">
              <button type="button" onClick={handleShareFacebook} className="btn-social facebook" title="Share on Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </button>
              <button type="button" onClick={handleShareInstagram} className="btn-social instagram" title="Share on Instagram">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <button type="button" onClick={handleShareWhatsApp} className="btn-social whatsapp" title="Share on WhatsApp">
                <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <button type="button" onClick={handleCopyLink} className="btn-social copy" title="Copy Link">
              ...
              {navigator.share && (
                <button type="button" onClick={handleNativeShare} className="btn-social native" title="More sharing options">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
